...
// Hacer una solicitud a la API para obtener las categorías de caballeros
fetch('http://localhost:8080/api/categories/Caballeros')
...
// Termina solicitud a la API para obtener las categorías de caballeros

// Hacer una solicitud a la API para obtener los Productos de caballeros
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function obtenerProductos(categorias) {
        ...
        fetch(`http://localhost:8080/api/products/Caballeros/${categorias}`)
            .then(response => response.json())
            .then(productos => {
    ...
    function renderizarProductos(productos, container) {
        ...
        productos.forEach((producto) => {
            ...
            botonAgregarAlCarrito.addEventListener('click', () => {
                ...
                agregarAlCarritoCaballero(productoParaAgregar);
            });
        });
        const agregarAlCarritoCaballero = (producto) => {
...
//Termina hacer una solicitud a la API para obtener los Productos de Caballeros

//Detalle de carrito
//Termina detalles de carrito