...
// Hacer una solicitud a la API para obtener las categorías de Ninos
fetch('http://localhost:8080/api/categories/Ninos')
...
//Termina hacer una solicitud a la API para obtener las categorías de Nino

// Hacer una solicitud a la API para obtener los Productos de Nino
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function obtenerProductos(categorias) {
        ...
        fetch(`http://localhost:8080/api/products/Ninnos/${categorias}`)
            .then(response => response.json())
            .then(productos => {
    ...
    function renderizarProductos(productos, container) {
        ...
        productos.forEach((producto) => {
            ...
            botonAgregarAlCarrito.addEventListener('click', () => {
                ...
                agregarAlCarritoNinnos(productoParaAgregar);
            });
        });
        const agregarAlCarritoNinnos = (producto) => {
...
//Termina hacer una solicitud a la API para obtener los Productos de Nino